...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["project_type"]) {
            // line 19
            echo "  <h3>";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["project_type"], "label", []), "html", null, true));
            echo "</h3>
  ";
            // line 20
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["project_type"], "table", []), "html", null, true));
            echo "
";
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/update-report.html.twig", "/Applications/MAMP/htdocs/drupal/my_site_name_dir/web/core/themes/stable/templates/admin/update-report.html.twig");
    }
}
