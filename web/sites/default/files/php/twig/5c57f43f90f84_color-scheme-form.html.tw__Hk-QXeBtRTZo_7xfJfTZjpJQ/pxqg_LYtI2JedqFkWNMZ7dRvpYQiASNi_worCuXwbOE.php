...
class __TwigTemplate_e415d60a285ef04c1fae93a3cb3f7a6c89e43f39b87f3864855baf00ae1b858c extends Twig_Template
{
  ...
  ";
        // line 17
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["form"] ?? null), "scheme", []), "html", null, true));
        echo "
  <div class=\"clearfix color-palette js-color-palette\">
    ";
        // line 19
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["form"] ?? null), "palette", []), "html", null, true));
        echo "
  </div>
  ";
        // line 21
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/color-scheme-form.html.twig", "/Applications/MAMP/htdocs/drupal/my_site_name_dir/web/core/themes/stable/templates/admin/color-scheme-form.html.twig");
    }
}
